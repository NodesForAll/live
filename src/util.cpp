...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Nodes
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Nodes
    // Mac: ~/Library/Application Support/Nodes
    // Unix: ~/.Nodes
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Nodes";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "Nodes.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "Nodesd.pid"));
