...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "Nodes.lnk";
}
...
bool SetStartOnSystemStartup(bool fAutoStart)
{
    ...
    if (fAutoStart)
    {
        ...
        // Get a pointer to the INodesLink interface.
        IShellLink* psl = NULL;
        ...
        if (SUCCEEDED(hres))
        {
            ...
            // Query INodesLink for the IPersistFile interface for
...
{
    return GetAutostartDir() / "Nodes.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("Nodes-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  Nodes-qt [" + tr("command-line options") + "]                     " + "\n";
